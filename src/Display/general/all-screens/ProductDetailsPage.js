        ...
        {product && (
          <div className="productInfoContainer">
                ...
                <div className="sectionWrap">
                  ...
                  <div className="section2">
                      ...
                      <div className="itemDetailinfoContainer">
                        ...
                        <div className="itemDetailinfoContainerPromo">
                          ...
                          <span className="amount">
                            <span className="currency">$</span>259.99
                          </span>
                        </div>
                    ...
                    <section id="sec3">
                      ...
                      <ul>
                        <li>
                          IN THE BOX: 8-pack of 1.5 volt AA alkaline batteries
                          for reliable performance across a wide range of
                          devices
                        </li>
                        <br />
                        <li>
                          DEVICE COMPATIBLE: Ideal battery for game controllers,
                          toys, flashlights, digital cameras, clocks, and more
                        </li>
                        <br />
                        <li>
                          DESIGNED TO LAST: 10-year leak-free shelf life; store
                          for emergencies or use right away
                        </li>
                        <br />
                        <li>
                          EASY USE & STORAGE: Ships in Certified
                          Frustration-Free Packaging; easy to open and store
                          extras for later use
                        </li>
                        <br />
                        <li>
                          SINGLE USE: These batteries are NOT rechargeable; for
                          rechargeable options, check out Amazon Basics
                   ...
                   <div></div>
                    ...
                    <div className="BuyItWithContainer">
                      ...
                      <form className="">
                        ...
                        <label>
                          {" "}
                          This item: Apple Watch Series 6 (GPS, 44mm) - Space
                          Gray Aluminum Case with Black Sport Band (Renewed)
                          $274.9
                        </label>
                        <br />
                        <br />
                        ...
                        <label>
                          {" "}
                          Misxi 2 Pack Hard PC Case with Tempered Glass Screen
                          Protector Compatible with Apple Watch SE Series 6
                          Series 5 $10.99
                        </label>
                        <br />
                        <br />
                        ...
                        <label>
                          {" "}
                          Smiling Case Compatible with Apple Watch Series
                          6/SE/Series 5/Series 4 44mm with Built in Tempered
                          Glass Screen $8.99
                        </label>
                        <br />
                        <br />
            ...
            <div className="brandcategoryContainer">
             ...
             <div className="desktopHorizontaScroll">
                <HorizontalScroll height='15rem' width='100%'
                >
                  ...
                  product?.compareImg?.map((item, i) => (
                    <div className="compareContainerImg" key={i}>
                      <div className="compareContainerImgDetails">
                        ...
                        <div className="title">
                          <span>
                            Apple Watch Series 6 (GPS, 44mm) - Blue Aluminum
                            Case with Deep Navy Sport Band (Renewed)$
                          </span>{" "}
                          <br />
                        </div>
                      </div>

...
import { pDTemplateSwitch } from "../../../redux/actions";
...
import Slider from "../../../comp-files/components/Slider";
                            ...
                            <div className="column3">
                                <div className="contain__heading">
                                    ...
                                    <div className="sellersHeaderIcon">
                                        ...
                                        <IoIosPeople size={20} onClick={()=>clickHandler('sellers')}  className="Icon"/> 
